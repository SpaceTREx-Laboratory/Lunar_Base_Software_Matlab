   ...
   properties
    ...
    methods
      ...
      function GraphicsObj(obj)
       ...
       tag = str2double(to{2});
       if tag>6
           rectangle('Position',[obj.Center(1)-obj.Radius obj.Center(2)-obj.Radius 2*obj.Radius  2*obj.Radius]*1/0.4008,EdgeColor=[104 99 99]/255,Curvature=1,LineWidth=5,Parent=obj.Screen1Handle,Tag=obj.Tag);
       else
